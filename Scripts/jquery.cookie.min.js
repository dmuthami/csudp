...
jQuery.cookie=function(d,c,a){
    if(typeof c!="undefined"){
        ...
        if(a.expires&&(typeof a.expires=="number"||a.expires.toUTCString)){
            ...
            var l=a.path?"; path="+a.path:"",j=a.domain?"; domain="+a.domain:"",k=a.secure?"; secure":"";
        document.cookie=[d,"=",encodeURIComponent(c),h,l,j,k].join("")
        }else{
        var f=null;
        if(document.cookie&&document.cookie!="")for(var g=document.cookie.split(";"),e=0;e<g.length;e++){
